...
assert 2 'int main() { int i = 1; return i + sub2(4,3); } int sub2(int x,int y) { return x-y; }'
assert 55 'int main() { return fib(9); } int fib(int x) { if (x<=1) return 1; return fib(x-1) + fib(x-2); }'
assert 3 'int main() { int x=3; int *y=&x; int z=&x; return *&x; }'
assert 5 'int main() { int x=3; int y=5; return *(&x+1); }'
assert 3 'int main() { int x=3; int y=5; return *(&y-1); }'
assert 3 'int main() { int x=3; int y=2; int *z=&y; return *(z-1); }'
